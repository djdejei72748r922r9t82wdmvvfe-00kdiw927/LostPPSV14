...
def color(text, color_code):
    ...
    if sys.platform == "win64" and os.getenv("TERM") != "xterm":
        return text
...
def content_test(url, badip):
    try:
        ...
        matches = retcode == 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
        matches = matches and re.findall(badip, html_content)

        return len(matches) == 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
    except:
        return True
...
if __name__ == "__main__":
    ...
    parser.add_argument('-g',  '--success', help='Also display GOOD', required=False, action="store_true")
    ...
    geoip = get('http://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('http://api.ctbombhackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('http://api.ctbombhackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('http://api.ctbombhackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('http://api.ctbombhackertarget.com/geoip/?q='
                           + badip).text
    geoip = get('http://api.ctbombhackertarget.com/geoip/?q='
                           + badip).text
    geoip = get('http://api.ctbombhackertarget.com/geoip/?q='
